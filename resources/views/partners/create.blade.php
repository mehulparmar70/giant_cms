...
<form id="addpartners" enctype="multipart/form-data" method="post" class="form-horizontal" onsubmit="return false;">
  <div class="cmsModal-formGroup">
  @csrf
  <div class="row">
    <div class="col-sm-4">
      <label class="cmsModal-formLabel" for="title">Add Partners Title</label>
      <input type="text" class="cmsModal-formControl" name="title" placeholder="Partners Title" value="{{old('title')}}"
        required>
      <span class="text-danger">@error('title') {{$message}} @enderror</span>
    </div>
    <div class="col-sm-4">
      <label class="cmsModal-formLabel" for="title">Add Partners Short Description</label>
    ...
    <div class="col-sm-4">
      <label class="cmsModal-formLabel" for="title">Add Partners Page Url</label>
      <input type="text" class="cmsModal-formControl" name="slug" placeholder="Url" value="{{old('slug')}}" required>
      <span class="text-danger">@error('slug') {{$message}} @enderror</span>
    </div>
    <div class="col-sm-12 mt-3">
      <label class="cmsModal-formLabel" for="full_description">Add Partners Description</label>
  ...
  <div class="form-group row mt-3">
    <div class="col-sm-6 col-md-6">
      <div class="col-sm-12">
        <label class="cmsModal-formLabel" for="image_alt">Add Partners Image</label><br>
  ...
  <div class="card-footer text-center">
    <button type="button" onclick="addpartnersubmit()" class="cmsBtn blue"><i class="fa fa-floppy-o"
        aria-hidden="true"></i>
      Save</button>
  </div>
  </div>
