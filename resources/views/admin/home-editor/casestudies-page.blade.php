                  ...
                  <div class=" p-2">
                    <div class="form-group row">
                      <div class="col-sm-4 mt-4">
                        <label  class="" for="meta_description" class="cmsModal-formLabel">Page Short Description</label>
...
<span class="text-danger"></span>
            ...
            value="{{ old('name', $url_list->name ?? '') }}">
                  ...
                  @if(request()->get('onscreenCms') == 'true')
                    ...
                    Save & Close</button>
                  @else
                    <button type="submit" class="cmsBtn blue"><i class="fa fa-floppy-o" aria-hidden="true"></i>&nbsp;&nbsp;Save Data</button>
                  @endif
