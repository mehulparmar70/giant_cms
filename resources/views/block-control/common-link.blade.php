...
$( ".row_position" ).sortable({
      stop: function() {
        ...
        toastr.success('Item Order Updated...');
        }
  });
        ...
        <div class="row">
          ...
          <div class="col-md-5 card card-theme">
              <div class="card-header">
                ...
                action="{{route('admin.commonLink.store')}}">
                    ...
                    <select class="form-control" name="item_id" required>
                        ...
                        @foreach($tableDatas as $tableData)
                            ...
                            @if(isset($tableData->name))
                                <option value="{{$tableData->id}}">@if($tableData->name){{$tableData->name}}@endif</option>
                            @elseif(isset($tableData->title))
                                <option value="{{$tableData->id}}">@if(isset($tableData->title)){{$tableData->title}}@endif</option>
                            @else
                                <option value="{{$tableData->id}}">@if(isset($tableData->short_description)){{$tableData->short_description}}@endif</option>
                            @endif
  ...
  <div class="modal fade" id="modal-default">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <label class="text-capitalize">{{$pageTitle}} Link Name</label>
