...
<form id="editblogajax" enctype="multipart/form-data" method="post" class="form-horizontal" onsubmit="return false;">
  ...
  <div class="row">
    <div class="col-sm-4">
      <label class="cmsModal-formLabel" for="title">Edit Update Title</label>
    ...
    <div class="col-sm-4">
      <label class="cmsModal-formLabel" for="title">Edit Update Short Description</label>
    ...
    <div class="col-sm-4">
      <label class="cmsModal-formLabel" for="title">Edit Update Page Url</label>
  ...
  <div class="form-group row mt-3">
    <div class="col-sm-6 col-md-6">
      <div class="col-sm-12">
        <label class="cmsModal-formLabel" for="image_alt">Edit Update Image</label><br>
