...
<!-- Contact form header -->
					<div class="enquiry_form bg-white" class="d-none"
					style="width: 100%;margin: 0px !important;max-width: inherit;min-width: inherit;
						box-shadow: none;border-radius: unset;"
					>
						...
						<form class="m-0 contact-submission px-2" 
...
<option value="Zimbabwe">Zimbabwe</option>
							...
							<div class="text-center"> 
								<a href="#;" class="term_Link d-block mb-4"> Your information is sage with us.
									<br/> We do not sell or rent emails. </a> 
