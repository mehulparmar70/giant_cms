...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm  modal-sm modal-dialog-centered" role="document">
...
<!-- Product Enquiry Page -->
    <div class="enquiry_form bg-white">
						...
						<form class="m-0 contact-submission" action="{{route('send-enquiry')}}" method="post">
						<input type="hidden" name="token_response" class="token_response">

						@csrf
  <input type="hidden" name='title' class="form-control card-title" value="">
  <input type="hidden" name='image' class="form-control card-image" value="">
  <input type="hidden" name='product_url' class="form-control card-product-url" value="">
...
<option value="Zimbabwe">Zimbabwe</option>
							...
							<div class="form-group">
								...
								<textarea placeholder="Share Your Inflatables Requirement" name="message" required></textarea>
							</div>
							<div class="text-center"> 
								<a href="#;" class="term_Link d-block mb-4"> Your information is sage with us.<br/?> We do not sell or rent emails. </a> 
...
<!-- 
  ...
  <input type="text" name='title' class="form-control card-title" value="">
  <input type="hidden" name='image' class="form-control card-image-link" value="">

  <blockquote class="blockquote">
    <p class = "full-description"></p>
  </blockquote>

  <img class="card-img" src="" alt="Card image cap" style="width:200px">
...
<option value="Zimbabwe">Zimbabwe</option>
    ...
    <br>
    <div class="form-group">
        <textarea class="form-control" placeholder="Share Your Inflatables Requirement" 
    ...
    <div class="text-center"> 
        ...
        <button type="submit" class="red_btn">Enquire Now</a>
    </div>

</form>

  
  <div class="col-sm-12 video_block">
